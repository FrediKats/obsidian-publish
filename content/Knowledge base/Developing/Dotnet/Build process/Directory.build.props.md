...
Directory.build.props - это специальный файл [MSBuild](./MSBuild.md)'а, который позволяет задавать шаренные настройки для [Dotnet project](./Dotnet%20project.md). Созданный файл с таким названием в корневой директории солюшена будет влиять на настройки все проекты в этой директории. Синтаксис описания файла такой же, как и у csproj файла:
```xml
<Project>
	<PropertyGroup>
